...
def engine_draw(engine : ToolEngine, time_delta_s : float):
    ...
    engine.position_data_to_be_published.angle = float(engine.rover_heading_angle_estimate_deg) + random.gauss(0, 10)
...
def main(args=None):
    ...
    engine = ToolEngine(
        ...
        window_title = 'FRIPS Simulator w AWGN',
        node_name = 'gauss_simulator_node',
        x_min = -1, x_max = 1,
        y_min = -1, y_max = 1,
